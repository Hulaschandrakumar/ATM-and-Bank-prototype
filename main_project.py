...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="#9933ff",
                                foreground="#00ffff",
                                font="-family {Segoe UI} -size 10 -weight bold",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", borderwidth="0", width=10, background="#9933ff",
                                     foreground="#00ffff",
                                     font="-family {Segoe UI} -size 10 -weight bold",
                                     command=self.back)
        self.Button_back.place(relx=0.545, rely=0.755)
...
class createCustomerAccount:
    def __init__(self, window=None):
        ...
        self.Entry1 = tk.Entry(window, background="#cae4ff", disabledforeground="#a3a3a3", font="TkFixedFont",
                               ...
                               insertbackground="black", selectbackground="yellow", selectforeground="white")
        self.Entry1.place(relx=0.511, rely=0.027, height=20, relwidth=0.302)

        self.Label1 = tk.Label(window, activebackground="#ff9999", activeforeground="black", background="#ffff99",
        ...
        self.Label2 = tk.Label(window, activebackground="#ff9999", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
        ...
        self.Entry2 = tk.Entry(window, background="#cae4ff", disabledforeground="#a3a3a3",
                               ...
                               highlightcolor="black", insertbackground="black", selectbackground="yellow",
                               selectforeground="white")
        self.Entry2.place(relx=0.511, rely=0.099, height=20, relwidth=0.302)

        self.Label3 = tk.Label(window, activebackground="#ff9999", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
        ...
        self.Label5 = tk.Label(window, activebackground="#ff9999", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000",
                               highlightcolor="black", text='''Mobile number:''')
        self.Label5.place(relx=0.268, rely=0.323, height=22, width=85)

        self.Label4 = tk.Label(window, activebackground="#ff9999", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000",
        ...
        self.Label6 = tk.Label(window, activebackground="#ff9999", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000",
        ...
        self.Label7 = tk.Label(window, activebackground="#ff9999", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
        ...
        self.Label9 = tk.Label(window, activebackground="#ff9999", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
                               highlightcolor="black", text='''PIN:''')
        self.Label9.place(relx=0.399, rely=0.62, height=21, width=35)

        self.Label10 = tk.Label(window, activebackground="#ff9999", activeforeground="black", background="#ffff99",
                                disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
                                highlightcolor="black", text='''Re-enter PIN:''')
        self.Label10.place(relx=0.292, rely=0.695, height=21, width=75)

        self.Label11 = tk.Label(window, activebackground="#ff9999", activeforeground="black", background="#ffff99",
                                disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
...
class customerMenu:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(self.Labelframe1, command=self.selectWithdraw, activebackground="#yellow",
        ...
        self.Button2 = tk.Button(self.Labelframe1, command=self.selectDeposit, activebackground="#yellow",
                                 activeforeground="#000000", background="#39a9fc", borderwidth="0",
                                 disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 11", foreground="#99ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0", text='''Deposit''')
        self.Button2.place(relx=0.04, rely=0.195, height=34, width=181, bordermode='ignore')

        self.Button3 = tk.Button(self.Labelframe1, command=self.exit, activebackground="#yellow",
...
class depositMoney:
    def __init__(self, window=None):
        ...
        self.Entry1 = tk.Entry(window, background="#cae4ff", disabledforeground="#a3a3a3", font="TkFixedFont",
                               foreground="#000000", insertbackground="black", selectforeground="#00ffff00ffff")
