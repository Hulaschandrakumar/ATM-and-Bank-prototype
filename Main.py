...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        self.Canvas1 = tk.Canvas(window, background="#9933ff", borderwidth="0", insertbackground="black",
                                 relief="ridge",
                                 selectbackground="#00ffff", selectforeground="white")
        self.Canvas1.place(relx=0.190, rely=0.228, relheight=0.496, relwidth=0.622)

        self.Button1 = tk.Button(self.Canvas1, command=self.selectEmployee, activebackground="#ffff00",
                                 activeforeground="#000000", background="#99ffff", disabledforeground="#a3a3a3",
                                 foreground="#0000ff", borderwidth="0", highlightbackground="#ff99cc",
        ...
        self.Button2 = tk.Button(self.Canvas1, command=self.selectCustomer, activebackground="#ffff00",
                                 activeforeground="#000000", background="#99ffff", disabledforeground="#a3a3a3",
                                 foreground="#0000ff", borderwidth="0", highlightbackground="#ff99cc",
                                 highlightcolor="black", pady="0",
                                 text='''CUSTOMER''')
        ...
        self.Label1 = tk.Label(self.Canvas1, background="yellow", disabledforeground="#a3a3a3",
...
class Error:
    def __init__(self, window=None):
        ...
        window.resizable(0, 0)
        window.title("Error")
        window.configure(background="#ffff99")

        global Label2

        self.Button1 = tk.Button(window, background="#d3d8dc", borderwidth="1", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 9", foreground="#000000", highlightbackground="#ff99cc",
        ...
        self.Label1 = tk.Label(window, background="#ffff99", disabledforeground="#a3a3a3", foreground="#000000",
                               image=_img0, text='''Label''')
        self.Label1.place(relx=0.024, rely=0.0, height=81, width=84)

    def setMessage(self, message_shown):
        Label2 = tk.Label(master, background="#ffff99", disabledforeground="#a3a3a3",
...
class adminLogin:
    def __init__(self, window=None):
        ...
        window.resizable(0, 0)
        window.title("Admin")
        window.configure(background="#9933ff")

        global Canvas1
        Canvas1 = tk.Canvas(window, background="#00ffff", insertbackground="black", relief="ridge",
                            selectbackground="yellow", selectforeground="white")
        Canvas1.place(relx=0.108, rely=0.142, relheight=0.715, relwidth=0.798)

        self.Label1 = tk.Label(Canvas1, background="#00ffff", disabledforeground="#a3a3a3",
                               font="-family {Segoe UI} -size 14 -weight bold", foreground="#00254a",
                               text="Admin Login")
        self.Label1.place(relx=0.135, rely=0.142, height=41, width=154)

        global Label2
        Label2 = tk.Label(Canvas1, background="#00ffff", disabledforeground="#a3a3a3", foreground="#000000")
        ...
        self.Entry1_1 = tk.Entry(Canvas1, show='*', background="#e2e2e2", borderwidth="2",
                                 ...
                                 highlightbackground="#ff99cc", highlightcolor="#004080", insertbackground="black",
                                 selectbackground="yellow", selectforeground="white")
        self.Entry1_1.place(relx=0.607, rely=0.623, height=20, relwidth=0.26)

        self.Label3 = tk.Label(Canvas1, background="#00ffff", disabledforeground="#a3a3a3", foreground="#000000")
        ...
        self.Label4 = tk.Label(Canvas1, background="#00ffff", disabledforeground="#a3a3a3", foreground="#000000")
        ...
        self.Label5 = tk.Label(Canvas1, background="#00ffff", disabledforeground="#a3a3a3", foreground="#000000")
        ...
        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="#ffccff",
                                foreground="#00254a",
                                font="-family {Segoe UI} -size 10 -weight bold",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", borderwidth="0", width=10, background="#ffccff",
                                     foreground="#00254a",
                                     font="-family {Segoe UI} -size 10 -weight bold",
                                     command=self.back)
...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        window.configure(background="#990099")
        ...
        Label1 = tk.Label(Canvas1, background="#00ffff", disabledforeground="#a3a3a3",
                          font="-family {Segoe UI} -size 14 -weight bold", foreground="#00254a",
                          text="Customer Login")
        ...
        global _img2
        _img2 = tk.PhotoImage(file="./images/lock1.png")
        self.Label4.configure(image=_img2, background="#00ffff")
    ...
    @staticmethod
    def setImg():
        settingIMG = tk.Label(Canvas1, background="#00ffff", disabledforeground="#a3a3a3", foreground="#000000")
...
class adminMenu:
    def __init__(self, window=None):
        ...
        self.Labelframe1 = tk.LabelFrame(window, relief='groove', font="-family {Segoe UI} -size 13 -weight bold",
                                         foreground="#001c37", text="Select your option", background="#99ffff")
        self.Labelframe1.place(relx=0.081, rely=0.081, relheight=0.415, relwidth=0.848)

        self.Button1 = tk.Button(self.Labelframe1, activebackground="#ffff00", activeforeground="#000000",
                                 background="#00254a", borderwidth="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#99ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0",
        ...
        self.Button2 = tk.Button(self.Labelframe1, activebackground="#ffff00", activeforeground="#000000",
                                 background="#00254a", borderwidth="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#99ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0",
        ...
        self.Button3 = tk.Button(self.Labelframe1, activebackground="#ffff00", activeforeground="#000000",
                                 background="#00254a", borderwidth="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#99ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0", text="Exit",
                                 command=self.exit)
        self.Button3.place(relx=0.667, rely=0.683, height=34, width=181, bordermode='ignore')

        self.Button4 = tk.Button(self.Labelframe1, activebackground="#ffff00", activeforeground="#000000",
                                 background="#00254a", borderwidth="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#99ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0",
        ...
        self.Button5 = tk.Button(self.Labelframe1, activebackground="#ffff00", activeforeground="#000000",
                                 background="#00254a", borderwidth="0", disabledforeground="#a3a3a3",
                                 font="-family {Segoe UI} -size 11", foreground="#99ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0",
        ...
        self.Button6 = tk.Button(self.Labelframe1, activebackground="#ffff00", activeforeground="#000000",
                                 background="#00254a", foreground="#99ffff", borderwidth="0",
        ...
        global Frame1
        Frame1 = tk.Frame(window, relief='groove', borderwidth="2", background="#99ffff")
    ...
    def printAccountSummary(identity):
        ...
        output_message = Label(Frame1, text=output, background="#99ffff")
...
class CloseAccountByAdmin:
    def __init__(self, window=None):
        ...
        self.Label1 = tk.Label(window, background="#ffff99", disabledforeground="#a3a3a3",
        ...
        self.Button1 = tk.Button(window, activebackground="#ffff00", activeforeground="#000000", borderwidth="0",
                                 background="#004080", disabledforeground="#a3a3a3", foreground="#00ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0", text="Back",
                                 command=self.back)
        self.Button1.place(relx=0.230, rely=0.598, height=24, width=67)

        self.Button2 = tk.Button(window, activebackground="#ffff00", activeforeground="#000000", background="#004080",
                                 borderwidth="0", disabledforeground="#a3a3a3", foreground="#00ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0", text="Proceed",
...
class createCustomerAccount:
    def __init__(self, window=None):
        ...
        window.configure(background="#ffff99")
        window.configure(highlightbackground="#ff99cc")
        window.configure(highlightcolor="black")

        self.Entry1 = tk.Entry(window, background="#cae4ff", disabledforeground="#a3a3a3", font="TkFixedFont",
                               foreground="#000000", highlightbackground="#ff99cc", highlightcolor="black",
                               insertbackground="black", selectbackground="#00ffff", selectforeground="white")
        self.Entry1.place(relx=0.511, rely=0.027, height=20, relwidth=0.302)

        self.Label1 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
                               highlightcolor="black", text='''Account number:''')
        self.Label1.place(relx=0.219, rely=0.025, height=26, width=120)

        self.Label2 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
        ...
        self.Entry2 = tk.Entry(window, background="#cae4ff", disabledforeground="#a3a3a3",
                               font="TkFixedFont", foreground="#000000", highlightbackground="#ff99cc",
                               highlightcolor="black", insertbackground="black", selectbackground="#00ffff",
                               selectforeground="white")
        self.Entry2.place(relx=0.511, rely=0.099, height=20, relwidth=0.302)

        self.Label3 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
        ...
        self.Radiobutton1 = tk.Radiobutton(window, activebackground="#ffff00", activeforeground="#000000",
                                           background="#ffff99", disabledforeground="#a3a3a3", foreground="#000000",
                                           highlightbackground="#ff99cc", highlightcolor="black", justify='left',
                                           text='''Savings''', variable=acc_type, value="Savings")
        self.Radiobutton1.place(relx=0.511, rely=0.174, relheight=0.057, relwidth=0.151)

        self.Radiobutton1_1 = tk.Radiobutton(window, activebackground="#ffff00", activeforeground="#000000",
                                             background="#ffff99", disabledforeground="#a3a3a3", foreground="#000000",
                                             highlightbackground="#ff99cc", highlightcolor="black", justify='left',
        ...
        self.Label5 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000",
                               highlightcolor="black", text='''Mobile number:''')
        self.Label5.place(relx=0.268, rely=0.323, height=22, width=85)

        self.Label4 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000",
        ...
        self.Label6 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000",
        ...
        self.Radiobutton3 = tk.Radiobutton(window, activebackground="#ffff00", activeforeground="#000000",
                                           background="#ffff99", disabledforeground="#a3a3a3", foreground="#000000",
        ...
        self.Radiobutton4 = tk.Radiobutton(window, activebackground="#ffff00", activeforeground="#000000",
                                           background="#ffff99", disabledforeground="#a3a3a3", foreground="#000000",
                                           highlightbackground="#ff99cc", highlightcolor="black", justify='left',
        ...
        self.Label7 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
        ...
        self.Label9 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#ffff99",
                               disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
                               highlightcolor="black", text='''PIN:''')
        self.Label9.place(relx=0.399, rely=0.62, height=21, width=35)

        self.Label10 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#ffff99",
                                disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
                                highlightcolor="black", text='''Re-enter PIN:''')
        self.Label10.place(relx=0.292, rely=0.695, height=21, width=75)

        self.Label11 = tk.Label(window, activebackground="#f9f9f9", activeforeground="black", background="#ffff99",
                                disabledforeground="#a3a3a3", foreground="#000000", highlightbackground="#ff99cc",
                                highlightcolor="black", text='''Initial balance:''')
        self.Label11.place(relx=0.292, rely=0.779, height=21, width=75)

        self.Button1 = tk.Button(window, activebackground="#ffff00", activeforeground="#000000", background="#004080",
                                 borderwidth="0", disabledforeground="#a3a3a3", foreground="#00ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0", text='''Back''',
                                 command=self.back)
        ...
        self.Label8 = tk.Label(window, background="#ffff99", disabledforeground="#a3a3a3", foreground="#000000",
...
class createAdmin:
    def __init__(self, window=None):
        ...
        self.Label2 = tk.Label(window, background="#ffff99", disabledforeground="#a3a3a3", foreground="#000000",
                               text='''Enter password:''')
...
class customerMenu:
    def __init__(self, window=None):
        ...
        self.Labelframe1 = tk.LabelFrame(window, relief='groove', font="-family {Segoe UI} -size 13 -weight bold",
                                         foreground="#000000", text='''Select your option''', background="#99ffff")
        self.Labelframe1.place(relx=0.081, rely=0.081, relheight=0.415, relwidth=0.848)

        self.Button1 = tk.Button(self.Labelframe1, command=self.selectWithdraw, activebackground="#ffff00",
                                 activeforeground="#000000", background="#39a9fc", borderwidth="0",
                                 disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 11", foreground="#99ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0", text='''Withdraw''')
        self.Button1.place(relx=0.667, rely=0.195, height=34, width=181, bordermode='ignore')

        self.Button2 = tk.Button(self.Labelframe1, command=self.selectDeposit, activebackground="#ffff00",
                                 activeforeground="#000000", background="#39a9fc", borderwidth="0",
                                 disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 11", foreground="#99ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0", text='''Deposit''')
        self.Button2.place(relx=0.04, rely=0.195, height=34, width=181, bordermode='ignore')

        self.Button3 = tk.Button(self.Labelframe1, command=self.exit, activebackground="#ffff00",
                                 activeforeground="#000000",
                                 background="#39a9fc",
                                 borderwidth="0", disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 11",
                                 foreground="#99ffff", highlightbackground="#ff99cc", highlightcolor="black", pady="0",
                                 text='''Exit''')
        self.Button3.place(relx=0.667, rely=0.683, height=34, width=181, bordermode='ignore')

        self.Button4 = tk.Button(self.Labelframe1, command=self.selectChangePIN, activebackground="#ffff00",
                                 activeforeground="#000000", background="#39a9fc", borderwidth="0",
                                 disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 11", foreground="#99ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0", text='''Change PIN''')
        self.Button4.place(relx=0.04, rely=0.439, height=34, width=181, bordermode='ignore')

        self.Button5 = tk.Button(self.Labelframe1, command=self.selectCloseAccount, activebackground="#ffff00",
                                 activeforeground="#000000", background="#39a9fc", borderwidth="0",
                                 disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 11", foreground="#99ffff",
                                 highlightbackground="#ff99cc", highlightcolor="black", pady="0",
                                 text='''Close account''')
        ...
        global Frame1_1_2
        Frame1_1_2 = tk.Frame(window, relief='groove', borderwidth="2", background="#99ffff")
    ...
    def printMessage(self, output):
        ...
        for widget in Frame1_1_2.winfo_children():
            widget.destroy()
        # getting output_message and displaying it in the frame
        output_message = Label(Frame1_1_2, text=output, background="#99ffff")
        output_message.pack(pady=20)
...
class depositMoney:
    def __init__(self, window=None):
        ...
        self.Entry1 = tk.Entry(window, background="#cae4ff", disabledforeground="#a3a3a3", font="TkFixedFont",
                               foreground="#000000", insertbackground="black", selectforeground="#00000000ffff")
        self.Entry1.place(relx=0.535, rely=0.171, height=20, relwidth=0.253)

        self.Button1 = tk.Button(window, activebackground="#ffff00", activeforeground="#000000", background="#004080",
                                 disabledforeground="#a3a3a3", borderwidth="0", foreground="#00ffff",
        ...
        self.Button2 = tk.Button(window, activebackground="#ffff00", activeforeground="#000000", background="#004080",
                                 disabledforeground="#a3a3a3", font="-family {Segoe UI} -size 9", foreground="#00ffff",
                                 highlightbackground="#ff99cc", borderwidth="0", highlightcolor="black", pady="0",
                                 text='''Back''',
                                 command=self.back)
...
class changePIN:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(window, activebackground="#ffff00", activeforeground="#000000", background="#004080",
                                 disabledforeground="#a3a3a3", foreground="#00ffff", borderwidth="0",
                                 highlightbackground="#ff99cc",
                                 highlightcolor="black", pady="0", text='''Proceed''',
